...
public class CustomAdapter extends ArrayAdapter<Imagenes> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            //Ligamos el diseño con la actividad imagen, titulo...
        ...
        Glide.with(mContext).load(dataModel.imagen).error(Glide.with(mContext).load(R.mipmap.ic_launcher)).fitCenter().into(viewHolder.imagen);
